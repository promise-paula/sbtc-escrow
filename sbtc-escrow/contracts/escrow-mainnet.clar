...
;;              and sBTC fungible token escrows. Contract-caller auth,
;;              dispute timeouts, pause controls, and dual-asset support.
;;              First mainnet release (functionally identical to escrow-v6
;;              on testnet, deployed under the mainnet name for clarity).
;;
;; Token types:
